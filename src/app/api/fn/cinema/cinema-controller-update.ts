...
export function cinemaControllerUpdate(http: HttpClient, rootUrl: string, params: CinemaControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
