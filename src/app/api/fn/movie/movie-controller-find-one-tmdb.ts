...
export function movieControllerFindOneTmdb(http: HttpClient, rootUrl: string, params: MovieControllerFindOneTmdb$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
