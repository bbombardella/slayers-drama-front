...
export function movieControllerDetachGenre(http: HttpClient, rootUrl: string, params: MovieControllerDetachGenre$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
