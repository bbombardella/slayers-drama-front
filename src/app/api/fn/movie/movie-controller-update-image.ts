...
export function movieControllerUpdateImage(http: HttpClient, rootUrl: string, params: MovieControllerUpdateImage$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
